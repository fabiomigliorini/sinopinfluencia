  ...
  return (
    <div className="mb-6 flex flex-col gap-3 rounded-2xl border border-[#FFEB00]/60 bg-[#FFEB00]/15 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <button
        ...
        className="shrink-0 rounded-full bg-primary px-5 py-2.5 text-sm font-bold text-white transition-all duration-300 hover:scale-[1.03] hover:bg-primary/90 disabled:opacity-60 disabled:hover:scale-100"
      >

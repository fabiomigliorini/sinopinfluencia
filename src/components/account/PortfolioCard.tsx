            ...
            <div className="space-y-4">
              ...
              <DialogFooter className="gap-2 sm:justify-between">
                ...
                <button
                  type="button"
                  onClick={() => setStep(3)}
                  className="rounded-full bg-primary px-5 py-2.5 text-sm font-bold text-primary-foreground transition-all duration-300 hover:scale-105 hover:bg-primary/90"
                >
                  Continuar
                </button>
              </DialogFooter>

        ...
        <div className="mt-6 overflow-hidden rounded-[24px] bg-white p-7 shadow-[0_32px_70px_-28px_rgba(0,0,0,0.35)] md:p-9">
          ...
          {ready && !hasSession ? (
            <div className="mt-6 space-y-4">
              ...
              <Link
                to="/auth"
                className="block w-full rounded-full bg-primary py-3.5 text-center text-sm font-bold text-white shadow-lg shadow-primary/25 transition-all duration-300 hover:scale-105 hover:bg-primary/90"
              >
                Solicitar novo link
              </Link>
            </div>

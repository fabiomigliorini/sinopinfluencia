            ...
            <div className="flex flex-wrap gap-2">
              ...
              {(p.status !== "approved" || p.review_pending) && (
                <button
                  ...
                  className="rounded-full bg-primary px-4 py-2 text-xs font-bold text-primary-foreground transition-all duration-300 hover:scale-105 hover:bg-primary/90 disabled:opacity-60 disabled:hover:scale-100"
                >
                  Aprovar
                </button>
              )}
        ...
        <div className="mt-2 w-full space-y-4 rounded-2xl border border-border p-4">
          ...
          <div className="flex flex-wrap items-center gap-2 border-t border-border pt-3">
            ...
            <button
              ...
              className="rounded-full bg-primary px-4 py-2 text-xs font-bold text-primary-foreground shadow-lg shadow-primary/25 transition-all duration-300 hover:scale-105 hover:bg-primary/90 disabled:opacity-60 disabled:hover:scale-100"
            >
